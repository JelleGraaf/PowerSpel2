function Show-MapStatic {
    ...
    .DESCRIPTION
        ...
        The map is a static representation of all the rooms on the current floor. This limits the floor to a
        maximum of 20 tiles wide and 11 tiles high. If a room doesn't fit on the map, it will display an
        error message.
