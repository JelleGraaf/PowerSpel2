function Show-StartScreen {
    ...
    Write-Host ""
    Write-WordWrapHost "In this mode, you will be introduced to the basic game mechanics. You can practice with the commands and after that, you are ready to try the real game. What are you waiting for? Jump right in!"
    Write-Host ""
    Pause
}
